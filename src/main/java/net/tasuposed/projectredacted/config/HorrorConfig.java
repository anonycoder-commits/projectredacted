...
public class HorrorConfig {
    ...
    public static final IntValue ENTITY_303_SPAWN_CHANCE;
    public static final IntValue HEROBRINE_SPAWN_CHANCE;
    ...
    static {
        ...
        EVENT_FREQUENCY = builder
                ...
                .defineInRange("eventFrequency", 0.15D, 0.0D, 1.0D);
        
        ENTITY_303_SPAWN_CHANCE = builder
                .comment("Chance (1 in X) for Entity 303 to spawn in final stage")
                .defineInRange("entity303SpawnChance", 50, 1, 10000);
        
        HEROBRINE_SPAWN_CHANCE = builder
                .comment("Chance (1 in X) for Herobrine to appear")
                .defineInRange("herobrineSpawnChance", 150, 1, 10000);
